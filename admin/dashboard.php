...
<body>
  <div class="d-flex">
    ...
    <div class="content" style="max-width: 100%;">
      ...
      <div class="header text-center py-4 mb-4 bg-light rounded shadow-sm">
        <h1 class="text-dark fw-bold mb-1">Welcome, Admin!</h1>
        <p class="mb-0 text-muted">Manage your boarding house system</p>
      </div>
  ...
  <div class="col-md-3"> <!-- Shrinks width to 25% -->
    <div class="card text-center shadow-sm" style="height: 150px; width: 100%;"> <!-- Smaller height -->
  ...
  ?>
  <div class="col-md-3">
    <div class="card text-center shadow-sm" style="height: 150px; width: 100%;">
      <div class="card-body d-flex flex-column justify-content-center p-2">
